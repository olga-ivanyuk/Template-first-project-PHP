...
$sql = "SELECT id, title, image, description, body FROM posts
WHERE id ='$id'";
...
<section class="section-sm">
    <div class="container">
        <div class="row justify-content-center">
            <div clas=""col-lg-8  mb-5 mb-lg-0"">
                <h1>Edit post</h1>
                <form action="update.php" method="post" enctype="multipart/form-data">
                    <input type="text" value="<?= $post['id']?>"
                           class="form-control" name="id" id="id" required hidden>
                    <div class="form-group">
                        <label for="title">Title</label>
                        <input type="text" value="<?= $post['title']?>"
                               class="form-control" name="title" id="title" required><input type="text" value="<?= $post['title']?>" class="form-control" name="title" id="title" required>
